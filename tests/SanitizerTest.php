...
class SanitizerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function optional_fields_dataProvider()
    {
        return [
            ...
            // isOptional但是有默认值，则还是会返回对应的默认值（类似数据库的default机制）
            [[],            ['name' => Type::string()->defaultValue('Unknown')->isOptional()], ['name' => 'Unknown']],
    ...
    /**
     * @expectedException \Clazz\Typed\Exceptions\TooManyFieldsException
     */
    public function test_NoExtraFields1()
    {
        $type = Type::arr([
                'foo' => 'int',
                'bar' => 'int'
     ...
     *
     */
    public function test_NoExtraFields2()
    {
        $type = Type::arr([
            'foo' => 'int',
            'bar' => 'int'
